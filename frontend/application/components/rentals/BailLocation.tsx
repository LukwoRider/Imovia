...
export function BailLocation({ lease, onRefresh }: BailLocationProps) {
            ...
            <Modal visible={leaseManageVisible} animationType="slide" onRequestClose={() => setLeaseManageVisible(false)}>
                <View style={styles.modalContainer}>
                    ...
                    <ScrollView style={{ padding: 20 }}>
                        ...
                        <View style={styles.inputGroup}>
                            <Text style={styles.inputLabel}>JOUR DE PAIEMENT</Text>
                            <TextInput
                                value={leaseForm.payment_day}
                                onChangeText={val => setLeaseForm({ ...leaseForm, payment_day: val })}
                                keyboardType="numeric"
                                style={styles.input}
                                placeholder="5"
                            />
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <Text style={styles.inputLabel}>{formattedDate}</Text>
                        </View>
