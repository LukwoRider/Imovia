        ...
        <Card className="border-0 shadow-sm bg-white overflow-hidden">
            ...
            <CardContent className="space-y-4">
                <div
                    ...
                    className="group flex items-start gap-4 p-4 rounded-xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-[#3153A1]/30 transition-all cursor-pointer disabled:opacity-50"
                >
                    <div className="p-2 rounded-lg bg-white shadow-sm ring-1 ring-slate-200">
                        {isDownloadingAll ? (
                            <Loader2 className="h-5 w-5 text-[#3153A1] animate-spin" />
                        ) : (
