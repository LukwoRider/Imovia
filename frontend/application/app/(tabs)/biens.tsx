import AjouterBienModal, {
  TYPE_PROPERTY_TYPES,
} from '@/components/biens/AjouterBienModal';
...
import TypeBienSelect from '@/components/biens/TypeBienSelect';
...
export default function BiensPage() {
  ...
  const [typeBien, setTypeBien] = useState<TYPE_PROPERTY_TYPES | null>(null);
  ...
  const filteredBiens = useMemo(() => {
    ...
    return biens.filter((bien) => {
      ...
      if (typeBien && bien.type !== typeBien) {
        return false;
      }
  ...
  }, [search, surfaceMin, surfaceMax, loyerMin, loyerMax, biens, typeBien]);

  const totalPages = Math.max(
    1,
    Math.ceil(filteredBiens.length / ITEMS_PER_PAGE),
  );
        ...
        >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                {isOwnerOrAgencyRole(userRole)
                  ? 'Gérez vos logements et locataires'
        ...
        <View style={{ paddingHorizontal: 16, marginTop: 18 }}>
          {userRole &&
            (userRole.toLowerCase() === 'owner' ||
              ...
              userRole.toLowerCase() === 'propriétaire') && (
              <Pressable
          ...
          >
            ...
            <TypeBienSelect propertyType={typeBien} onChange={setTypeBien} />
          ...
          >
            <Text style={{ fontSize: 13, color: '#6b7280' }}>
              ...
              trouvé{filteredBiens.length > 1 ? 's' : ''}
            </Text>
          ...
          {loading ? (
            <View style={{ padding: 40, alignItems: 'center' }}>
              <Text
                style={{ color: '#6b7280', fontFamily: 'Montserrat_500Medium' }}
              >
