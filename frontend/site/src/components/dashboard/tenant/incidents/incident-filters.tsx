        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-6">
            <div className="relative w-full md:flex-1 md:max-w-2xl">
                ...
                <Input
                    ...
                    className="pl-11 bg-white border-slate-200 focus:border-[#3153A1] focus:ring-[#3153A1]/20 rounded-xl h-11"
                    ...
                    <Button
                        ...
                        className={cn(
                            ...
                            currentFilter === filter.id
                                ? "bg-[#3153A1] text-white shadow-md shadow-blue-900/10 hover:bg-[#25468d] hover:text-white"
                                : "text-slate-500 hover:text-[#12182C] hover:bg-slate-50"
                        )}
                    >
